...
class Go2Robot(LeggedRobot):
    def __init__(self, cfg, sim_params, physics_engine, sim_device, headless):
        ...
        self.debug_viz = False # NOTE: cannot be enabled if self.cfg.env.num_scan_obs == 0
    ...
    def compute_observations(self):
        ...
        # SCAN OBS
        if self.cfg.env.num_scan_obs > 0:
    ...
    def _reward_heading_alignment(self):
        ...
        # Compute desired vs. actual heading error [-pi, pi]
